...
import { queryAppTest } from './service';
...
const description = (
  <RouteContext.Consumer>
    {({ isMobile }) => (
      <Descriptions className={styles.headerList} size="default" column={isMobile ? 1 : 4}>
        <Descriptions.Item label="应用名称">遍历测试应用</Descriptions.Item>
        <Descriptions.Item label="测试方法">图片替代文本测试</Descriptions.Item>
        <Descriptions.Item label="创建时间">2022-11-03 21:34:30</Descriptions.Item>
        <Descriptions.Item label="测试状态">执行完成</Descriptions.Item>
        <Descriptions.Item label="应用版本">1.0.0</Descriptions.Item>
        <Descriptions.Item label="创建人">user01</Descriptions.Item>
        <Descriptions.Item label="运行时长">8分钟</Descriptions.Item>
        {/* <Descriptions.Item label="通过率">78%</Descriptions.Item> */}
...
const Advanced: FC = () => {
  ...
  const { data = {}, loading } = useRequest<{ data: AdvancedProfileData }>(queryAppTest);
  ...
  return (
    <PageContainer
      title={
        <>
          <Avatar size="large" src={'https://i.postimg.cc/RZbXszL5/test.png'} />
          <span>遍历测试应用</span>
        </>
